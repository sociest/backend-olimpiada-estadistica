...
class MaterialRepository:
    ...
    def replace_relations(self, material_id: int, id_convocatoria: int | None, id_categoria: int | None, id_fase: int | None):
        ...
        if id_convocatoria is not None:
            self.db.execute(insert(material_convocatoria).values(id_convocatoria=id_convocatoria, id_material=material_id))
